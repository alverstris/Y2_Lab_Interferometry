...
from curvefitting import scan_function, sinc_combo, fit_sinc_combo
...
# components, covariance = fit_sinc_combo(scanned_data[0], scanned_data[1])

# plt.plot(scanned_data[0], sinc_combo(scanned_data[0], *components))
plt.plot(scanned_data[0], scanned_data[1])
plt.show()
